...
class Episode{
  Future<SeasonEpisodes> details(int tvId, int seasonNumber, int episodeNumber, {String language}) async {
    var response = await http.get(UrlMaker.episode(tvId, seasonNumber,episodeNumber, language));
