...
class MoviePopular {
  ...
  int totalResults;
  int totalPages;
  List<MoviePopularResults> results;

  MoviePopular({this.page, this.totalResults, this.totalPages, this.results});
  ...
  MoviePopular.fromJson(Map<String, dynamic> json) {
    ...
    this.results = (json['results'] as List) != null
        ? (json['results'] as List)
            .map((i) => MoviePopularResults.fromJson(i))
            .toList()
        : null;
  }
