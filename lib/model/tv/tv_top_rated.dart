...
class TvTopRated {
  ...
  int totalResults;
  int totalPages;
  List<TvTopRatedResults> results;

  TvTopRated({this.page, this.totalResults, this.totalPages, this.results});
  ...
  TvTopRated.fromJson(Map<String, dynamic> json) {
    ...
    this.results = (json['results'] as List) != null
        ? (json['results'] as List)
            .map((i) => TvTopRatedResults.fromJson(i))
            .toList()
        : null;
  }
...
class TvTopRatedResults {
  ...
  TvTopRatedResults.fromJson(Map<String, dynamic> json) {
