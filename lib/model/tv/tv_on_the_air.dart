...
class TvOnTheAir {
  ...
  int totalResults;
  int totalPages;
  List<TvOnTheAirResults> results;

  TvOnTheAir({this.page, this.totalResults, this.totalPages, this.results});

  TvOnTheAir.fromJson(Map<String, dynamic> json) {
    this.page = json['page'];
    this.totalResults = json['total_results'];
    this.totalPages = json['total_pages'];
    this.results = (json['results'] as List) != null
        ? (json['results'] as List)
            .map((i) => TvOnTheAirResults.fromJson(i))
            .toList()
        : null;
  }
...
class TvOnTheAirResults {
  ...
  TvOnTheAirResults.fromJson(Map<String, dynamic> json) {
