...
class DiscoverTv {
  ...
  int totalResults;
  int totalPages;
  List<DiscoverTvResults> results;

  DiscoverTv({this.page, this.totalResults, this.totalPages, this.results});

  DiscoverTv.fromJson(Map<String, dynamic> json) {
    this.page = json['page'];
    this.totalResults = json['total_results'];
    this.totalPages = json['total_pages'];
    this.results = (json['results'] as List) != null
        ? (json['results'] as List)
            .map((i) => DiscoverTvResults.fromJson(i))
            .toList()
        : null;
  }
...
class DiscoverTvResults {
  ...
  DiscoverTvResults.fromJson(Map<String, dynamic> json) {
