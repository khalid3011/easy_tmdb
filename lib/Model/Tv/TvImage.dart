...
class TvImage {
  ...
  TvImage.fromJson(Map<String, dynamic> json) {
    ...
    this.backdrops = (json['backdrops'] as List)!=null?(json['backdrops'] as List).map((i) => TvImageBackdrops.fromJson(i)).toList():null;
    this.posters = (json['posters'] as List)!=null?(json['posters'] as List).map((i) => TvImagePosters.fromJson(i)).toList():null;
